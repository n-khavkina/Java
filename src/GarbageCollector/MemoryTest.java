...
public class MemoryTest {
     ...
     * -Xmx - максимальный размер кучи* -Xss - размер стека потоков
     * –XX:HeapDumpOnOutOfMemory -  создаст файл дампа кучи, когда эта ошибка произойдет в следующий раз.* -verbose:gc - чтобы получить вывод процесса сборки мусора
     */
